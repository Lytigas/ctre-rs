...
pub trait MotorController: private::Sealed {
    ...
    fn configure_filter(
        &mut self,
        filter: &config::FilterConfiguration,
        ordinal: i32,
        timeout_ms: i32,
    ) -> Result<()> {
    ...
    fn follow(
        &mut self,
        master_to_follow: &impl MotorController,
    ...
    fn configure_slot(
        ...
        self.config_allowable_closedloop_error(
            slot_idx,
...
impl TalonSRX {
    ...
    */
    ...
    pub fn configure_pid(
        &mut self,
        pid: &config::TalonSRXPIDSetConfiguration,
        pid_idx: i32,
        timeout_ms: i32,
    ) -> Result<()> {
        //------ sensor selection ----------//
    ...
    pub fn config_all(&mut self, config: &config::TalonSRXConfig, timeout_ms: i32) -> Result<()> {
        ...
        unsafe {
            c_MotController_ConfigForwardLimitSwitchSource(
                self.handle,
                config.forwardLimitSwitchSource as _,
                config.base.forwardLimitSwitchNormal as _,
                config.base.forwardLimitSwitchDeviceID,
                timeout_ms,
            )
        }
        .into_res()?;
        unsafe {
            c_MotController_ConfigReverseLimitSwitchSource(
                self.handle,
                config.reverseLimitSwitchSource as _,
                config.base.reverseLimitSwitchNormal as _,
                config.base.reverseLimitSwitchDeviceID,
                timeout_ms,
            )
        }
        .into_res()?;
